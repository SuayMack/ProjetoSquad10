...
const textoDepois1 = "Oferece aulas de 1 idioma básico para alunos que estão iniciando no aprendizado do idioma. Esse plano inclui aulas online, materiais de estudo e exercícios de fixação.";
const textoDepois2 = "Oferece aulas de 2 idiomas em um plano combinado, permitindo que os alunos aprendam esses dois idiomas simultaneamente. O plano pode inclui aulas individuais para cada idioma, além de oportunidades de prática de conversação em dois idiomas.";
const textoDepois3 = "Um plano voltado para profissionais que desejam aprimorar seus idiomas para o ambiente de negócios. O plano pode incluir aulas individuais com professores especializados em diversas línguas, oportunidades de prática de apresentações e discussões sobre casos de negócios.";
